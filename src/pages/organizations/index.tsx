...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'artillery_calculation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('artillery_calculation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'artillery_calculation',
          header: 'Artillery Calculation',
          accessorKey: 'artillery_calculation',
          cell: ({ row: { original: record } }: any) => record?._count?.artillery_calculation,
        }
      : null,
